		...
		{
			{
				...
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_b764ba756c6d3bfe53ad5a4cce394401);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_e2f92f45b944cb4d08fa8d23eb64a88e);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_c1ef8beb9efe4224fe3b522f215dfac5);
				sh.compile();
